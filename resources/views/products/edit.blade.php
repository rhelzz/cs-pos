...
<div x-data="{
    ...
    async init() {
        try {
            // Fetch ingredients
            const ingredientsResponse = await fetch('{{ route('ingredients.index') }}');
            const ingredientsData = await ingredientsResponse.json();
            this.ingredients = ingredientsData.ingredients;
            
            // Set existing ingredients
            const existingIngredients = @json($product->ingredients);
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <div class="relative rounded-md shadow-sm">
                                ...
                                <input type="number" name="selling_price" id="selling_price" value="{{ old('selling_price', $product->selling_price) }}" min="0" step="100" required
